                        ...
                        <tbody>
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                if (isset($_POST['issue_id']) && isset($_POST['admin_response'])) {
                                    ...
                                    $sql = 'UPDATE contactus SET message = :message, response_timestamp = NOW() WHERE id = :id';
                                    $stmt = $db->prepare($sql);
                                    $stmt->bindParam(':message', $adminResponse);
                                ...
                                echo '
                                    ...
                                    <td>'.$report['id'].'</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="delete-contact.php?id='.$report['id'].'"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                ';
                            }
